...
import com.agendamento.services.AgendamentoProcedimentoService;
...
public class AgendamentoProcedimentoResource {
	...
	public ResponseEntity<AgendamentoProcedimentoDTO> find(
	...
	public ResponseEntity<Void> update(@Valid @RequestBody AgendamentoProcedimentoDTO objDto,
			@RequestParam(value = "agendamentoId", defaultValue = "0") Integer agendamentoId,
			@RequestParam(value = "procedimentoId", defaultValue = "0") Integer procedimentoId) {
		AgendamentoProcedimento obj = service.fromDTO(objDto);
	...
	public ResponseEntity<Void> delete(@RequestParam(value = "agendamentoId", defaultValue = "0") Integer agendamentoId,
			@RequestParam(value = "procedimentoId", defaultValue = "0") Integer procedimentoId) {
	...
	public ResponseEntity<List<AgendamentoProcedimentoDTO>> findAll() {
		...
		List<AgendamentoProcedimentoDTO> listDTO = list.stream().map(obj -> new AgendamentoProcedimentoDTO(obj))
