...
import com.agendamento.services.ClienteService;
...
public class ClienteResource {
	...
	@RequestMapping(value = "/emailexiste", method = RequestMethod.GET)
	public ResponseEntity<EmailDTO> emailExiste(@RequestParam(value = "value") String email) {
		Cliente obj = service.findByEmail(email);
		EmailDTO emailDto = new EmailDTO(obj.getEmail());
